  ...
  return (
    <section id="testimonials" className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-3 glass-card rounded-xl p-6 lg:p-8 flex flex-col gap-5 relative overflow-hidden">
          <Quote className="absolute top-4 right-4 w-16 h-16 text-primary/5" />
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-border/50">
            <div className="flex items-center justify-center w-11 h-11 rounded-full bg-primary/10 text-primary font-display font-bold text-sm">
        ...
        {/* Side panel - all testimonials list */}
        <div className="lg:col-span-2 glass-card rounded-xl p-4 flex flex-col gap-2">
