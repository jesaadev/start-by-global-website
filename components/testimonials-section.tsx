...
const testimonials = [
  {
    ...
    quote: "Start By Global transformo nuestra presencia digital por completo. Nuestro tráfico web aumento un 300% en solo 6 meses y las conversiones se triplicaron.",
    rating: 5,
    metric: "+300% tráfico",
  },
  {
    ...
    region: "España",
    quote: "Profesionalismo excepcional. El equipo entendio nuestras necesidades desde el primer día y los resultados superaron todas nuestras expectativas.",
    rating: 5,
  ...
  },
  {
    ...
    region: "México",
    quote: "La mejor inversion que hemos hecho en marketing digital. Su enfoque basado en datos nos ayudo a escalar de manera sostenible en toda la región.",
    rating: 5,
    metric: "4x ROI",
  },
  {
