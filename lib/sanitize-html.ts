...
//  - El único atributo permitido es `href` en <a>, y su esquema se valida contra
//    una allowlist (http/https/mailto/tel/relativa/ancla) DESPUÉS de decodificar
//    entidades, de modo que `javascript:`/`data:` codificados (p. ej. `&#x6A;…`)
//    no puedan colarse.
//  - Se eliminan por completo bloques peligrosos (script/style/iframe…) y
//    caracteres de control.
//
// Nota: lo ideal sería una librería (DOMPurify/sanitize-html); este módulo
// expone la misma firma para poder sustituirla sin tocar a los consumidores.
